/*! Zepto slabtext plugin v2.3 MIT/GPL2 @freqdec */
(function( $ ){
    ...
    $.fn.slabText = function(options) {
        ...
        return this.each(function(){
            ...
            var grabPixelFontSize = function() {
                var dummy = Zepto('<div style="display:none;font-size:1em;margin:0;padding:0;height:auto;line-height:1;border:0;">&nbsp;</div>').appendTo($this),
                    emH   = dummy.height();
                dummy.remove();
                return emH;
            };
